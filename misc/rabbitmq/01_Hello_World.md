...
stdout >>> Consumer, <nil>
stdout >>> Start Consumer: helloworld-reader
stdout >>> helloworld-reader > Event #0
stdout >>> helloworld-reader > Event #1
stdout >>> helloworld-reader > Event #2
stdout >>> helloworld-reader > Event #3
stdout >>> helloworld-reader > Event #4
```
...
stdout >>> Cleanup...
stdout >>> Exiting consumer: helloworld-reader
```