...
stdout >>> 
stdout >>> amqp.Queue{Name:"amq.gen-WyOom2DRJrUXtoWQF8S6YA", Messages:0, Consumers:0}
stdout >>> 
stdout >>> amqp.Queue{Name:"amq.gen-5PmIU6Jj6PckwAPpS3rpsw", Messages:0, Consumers:0}
...
stdout >>> consumer: 0 > Event #0
stdout >>> Consumer, <nil>
stdout >>> Start Consumer: consumer: 1
stdout >>> consumer: 0 > Event #1
stdout >>> consumer: 1 > Event #0
stdout >>> consumer: 0 > Event #2
stdout >>> consumer: 1 > Event #1
stdout >>> consumer: 1 > Event #2
```
...
stdout >>> Queue To Be deleted: amqp.Queue{Name:"amq.gen-WyOom2DRJrUXtoWQF8S6YA", Messages:0, Consumers:1}, <nil>
stdout >>> Exiting consumer: consumer: 0
stdout >>> Queue To Be deleted: amqp.Queue{Name:"amq.gen-5PmIU6Jj6PckwAPpS3rpsw", Messages:0, Consumers:1}, <nil>
```