...
stdout >>> consumer: 0 > Event (all) #1
stdout >>> Consumer, <nil>
stdout >>> consumer: 0 > Event (all) #2
stdout >>> Start Consumer: consumer: 1
stdout >>> Consumer, <nil>
stdout >>> consumer: 0 > Event (all.fiz) #3
stdout >>> Start Consumer: consumer: 2
stdout >>> Consumer, <nil>
stdout >>> Start Consumer: consumer: 3
stdout >>> consumer: 3 > Event (all.fiz.buz) #15
stdout >>> consumer: 1 > Event (all.fiz) #3
stdout >>> consumer: 0 > Event (all) #4
stdout >>> consumer: 2 > Event (all.buz) #5
stdout >>> consumer: 1 > Event (all.fiz) #6
stdout >>> consumer: 2 > Event (all.buz) #10
stdout >>> consumer: 0 > Event (all.buz) #5
stdout >>> consumer: 0 > Event (all.fiz) #6
stdout >>> consumer: 1 > Event (all.fiz) #9
stdout >>> consumer: 0 > Event (all) #7
stdout >>> consumer: 0 > Event (all) #8
stdout >>> consumer: 1 > Event (all.fiz) #12
stdout >>> consumer: 0 > Event (all.fiz) #9
stdout >>> consumer: 0 > Event (all.buz) #10
stdout >>> consumer: 0 > Event (all) #11
stdout >>> consumer: 0 > Event (all.fiz) #12
stdout >>> consumer: 0 > Event (all) #13
stdout >>> consumer: 0 > Event (all) #14
stdout >>> consumer: 0 > Event (all.fiz.buz) #15
```
...
stdout >>> Cleanup...
stdout >>> Queue To Be deleted: amqp.Queue{Name:"amq.gen-FI-iFVqHj860A0tMxwXixQ", Messages:0, Consumers:1}, <nil>
stdout >>> Exiting consumer: consumer: 0
stdout >>> Queue To Be deleted: amqp.Queue{Name:"amq.gen-L2RVq5C208qDOIMYSwGbKA", Messages:0, Consumers:1}, <nil>
stdout >>> Exiting consumer: consumer: 3
stdout >>> Exiting consumer: consumer: 2
stdout >>> Queue To Be deleted: amqp.Queue{Name:"amq.gen-J8ghh9AR6HnWzfjxaGtYVw", Messages:0, Consumers:1}, <nil>
stdout >>> Exiting consumer: consumer: 1
stdout >>> Queue To Be deleted: amqp.Queue{Name:"amq.gen-Law9XxOLd9bGcgb6uS5x-g", Messages:0, Consumers:1}, <nil>
```