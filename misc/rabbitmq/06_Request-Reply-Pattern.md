...
stdout >>> Got Answer (body) - ping > pong 
stdout >>> Got Answer (correlation id) - 978063f1-8edd-4ead-ac2e-973c52c57860
```
...
stdout >>> Cleanup...
stdout >>> Queue To Be deleted: amqp.Queue{Name:"rpc_queue", Messages:0, Consumers:0}, Exception (504) Reason: "channel/connection is not open"
stdout >>> Queue To Be deleted: amqp.Queue{Name:"amq.gen-ICLLgRGJhr833OkwmS0RJA", Messages:0, Consumers:0}, Exception (504) Reason: "channel/connection is not open"
```